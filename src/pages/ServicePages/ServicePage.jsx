...
const ServicePage = ({ data }) => {
	const services = data?.serviceData?.services;
	return (
		<React.Fragment>
			<Helmet>
				<title>My Services - Fastone Personal Portfolio or CV/Resume React App</title>
			</Helmet>
			<Header2></Header2>
			<PageTitle title="My Services" hometitle="Home" homeURL="/" currentPage="My Services"></PageTitle>
			...
			<FreelanceWork2 />
			<FunFacts3 />
			<ContactUs2 socialData={data?.socialData} />
			<BottomBar2 />
		</React.Fragment>
	);
};
