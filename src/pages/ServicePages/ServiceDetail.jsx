...
const ServiceDetail = ({ data }) => {
	...
	return (
		<React.Fragment>
			<Helmet>
				<title>Service Detail - Fastone Personal Portfolio or CV/Resume React App</title>
			</Helmet>
			<Header2></Header2>
			<PageTitle title="Service Detail" hometitle="Home" homeURL="/" currentPage="Service Detail"></PageTitle>
					...
					<div className="servDetail relative w-full">
						<div className="servDetailTop gap-[1.875rem] lg:flex items-end relative w-full mb-[3.125rem] sm:mb-[4rem] md:mb-[5.3125rem]">
							<div className="servDetailImage relative rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] overflow-hidden w-full lg:max-w-[48.125rem]">
								<img className="w-full" src={services.servIcon} alt=""></img>
						...
						<div className="servDetailDesc flex flex-col gap-6 w-full">
							...
							<p className="text-desc2 font-NunitoSans font-normal text-[1rem] md:text-[1.125rem] leading-relaxed">
								...
								add. Chicken age had evening believe but proceed pretend mrs. At missed advice my it no
								sister. Miss told ham dull knew see she spot near can. Spirit her entire her called.
								Lorem ipsum dolor sit amet, consec tetur adipiscing elit. Ut elit tellus, luctus nec
								ullamcorper mattis, pulvinar.Lorem ipsum dolor sit amet, consec tetur adipiscing elit.
