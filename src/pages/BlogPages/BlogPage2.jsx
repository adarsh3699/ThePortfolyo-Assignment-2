...
const BlogPage2 = ({ data }) => {
	const { contactData, socialData, portfolioData } = data;
	return (
		<React.Fragment>
			<Helmet>
				<title>Blog 2 - Fastone Personal Portfolio or CV/Resume React App</title>
			</Helmet>
			<Header2></Header2>
			<PageTitle title="Blog & Insight" hometitle="Home" homeURL="/" currentPage="Blog"></PageTitle>
			<FreelanceWork3 />
