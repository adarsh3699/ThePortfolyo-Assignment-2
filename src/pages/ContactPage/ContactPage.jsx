...
const ContactPage = ({ data }) => {
	const { contactData, socialData } = data;
	return (
		<React.Fragment>
			<Helmet>
			...
			<Header2></Header2>
			<PageTitle title="Contact Me" hometitle="Home" homeURL="/" currentPage="Contact Me"></PageTitle>
			...
			<ContactUs contactData={contactData} socialData={socialData} />
