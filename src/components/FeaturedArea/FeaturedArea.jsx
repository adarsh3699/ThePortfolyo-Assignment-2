							...
							<div className="featuredImgWrap text-center w-full">
								<div className="featuredImgInner relative inline-block w-4/5 sm:w-full md:w-full lg:w-[26rem] xl:w-[35rem]">
									...
									<div className="featuredImg relative rounded-full">
										<img
											className="rounded-full relative z-[1] sm:w-[600px] sm:h-[600px]  w-[400px] h-[400px] md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[500px] xl:w-[600px] xl:h-[600px] object-cover"
											src={heroData.imgLink ? heroData.imgLink : FeatImg}
											alt=""
										></img>
										{/* Featured Image */}
									</div>
