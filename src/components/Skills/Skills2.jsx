							...
							index < 4 && (
								...
								>
									<img
										src={item.image}
										alt="skill"
										className="bg-white rounded-[10px] sm:rounded-[1.25rem] h-[4.375rem] w-[4.375rem] inline-flex items-center border-[3px] border-[#f2eafa] border-solid justify-center"
									/>
