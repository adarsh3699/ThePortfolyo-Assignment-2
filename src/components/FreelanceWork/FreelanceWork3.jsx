					...
					<div className="grid gap-[1.875rem] md:grid-cols-2 grid-cols-1 text-center md:text-left items-center">
						<div className="md:order-1 flex md:justify-end justify-center">
							<div className="freelanceImg max-w-[22.1875rem] w-full">
								<img
									...
									className="aspect-square md:w-max object-cover object-center rounded-[10px] sm:rounded-[1.25rem] md:rounded-r-[3.125rem] z-[1] m-[auto]"
								></img>
								{/* Freelance Image */}
							</div>
						</div>
						<div>
							<div className="freelanceInfo md:min-w-[120%] min-w-full w-full">
								...
								<h2 className="text-white font-Poppins font-bold text-[1.75rem] sm:text-[2.3rem] md:text-[2.3rem] lg:text-[2.875rem]">
									Freelance Work
								</h2>
